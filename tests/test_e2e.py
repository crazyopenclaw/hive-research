"""
End-to-end integration test for ResearchSquid.
...
Requires: SQUID_MOCK_LLM=true (uses mock LLM, no API keys needed)
...
# Enable mock LLM
os.environ["SQUID_MOCK_LLM"] = "true"
...
def test_schema_validation():
    ...
    from squid.schema.experiment import ExperimentSpec, BackendJudgment, ExperimentResult
...
def test_persona_system():
    ...
    from squid.agents.persona import (
...
def test_mock_llm():
    ...
    from squid.utils.mock_llm import MockLLMClient
...
def test_llm_client_mock_mode():
    ...
    from squid.utils.llm_client import get_llm_client, set_llm_client

    # Should be mock because SQUID_MOCK_LLM=true
...
def test_budget_enforcement():
    ...
    from squid.coordinator.budget import BudgetTracker, BudgetAction
...
def test_report_agent():
    ...
    from squid.coordinator.report_agent import _confidence_label, _tier_label
...
if __name__ == "__main__":
    print("=== ResearchSquid End-to-End Tests ===\n")
